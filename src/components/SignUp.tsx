...
const SignUp: FunctionComponent<SignUpProps> = () => {
  ...
  let formik = useFormik({
    ...
    onSubmit(values: User) {
      createUser(values)
        .then((res) => {
          res.data.isAdmin ? navigate("/mycards") : navigate("/allcards");
          sucessMsg(`Welcome ${res.data.name} you successfully registred!`);
          ...
          <div className="form-floating mb-3">
            ...
            <div className="form-check mt-2">
              <input
                ...
                type="checkbox"
                id="flexCheckDefault"
                onClick={() => (formik.values.isAdmin = !formik.values.isAdmin)}
              />
